...
@section('title', 'Tambah Jabatan Lowong')
@section('header-title', 'Tambah Jabatan Lowong')
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-4">Formulir Jabatan Lowong Baru</h6>

                    <form action="{{ route('lowong.store') }}" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="kj_api" name="kj_api" value="{{ old('kj_api') }}">
                            </div>
                        </div>
